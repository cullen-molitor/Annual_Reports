...
```{r ONI plot, fig.height=4, fig.width=8.5}
ggplot(SST_Anomaly_Index, aes(x = Date, y = ONI_ANOM, fill = ONI_ANOM)) +
...
Our generalized linear mixed model indicated significant effects of MPA status (P=`r fsc_MPA_p_val`), Island (P=`r fsc_Isl_p_val`), and their interaction (P=`r fsc_MPA_Isl_p_val`), but displayed distinct trends over time (Fig 11). More text will go here

Our generalized linear mixed model indicated significant effects of MPA status (P=`r strpur_MPA_p_val`), Island (P=`r strpur_Isl_p_val`), and their interaction (P=`r strpur_MPA_Isl_p_val`), but displayed distinct trends over time (Fig 12). More text will go here

Our generalized linear mixed model indicated significant effects of MPA status (P=`r mesfra_MPA_p_val`), Island (P=`r mesfra_Isl_p_val`), and their interaction (P=`r mesfra_MPA_Isl_p_val`), but displayed distinct trends over time (Fig 13). More text will go here
...
Our generalized linear mixed model indicated significant effects of MPA status (P=`r pychel_MPA_p_val`), Island (P=`r pychel_Isl_p_val`), and their interaction (P=`r pychel_MPA_Isl_p_val`), but displayed distinct trends over time (Fig 15). More text will go here
...
Our generalized linear mixed model indicated significant effects on community diversity (Shannon Index) of MPA status (P=`r div_MPA_p_val`), Island (P=`r div_Isl_p_val`), and their interaction (P=`r div_MPA_Isl_p_val`) (Fig 3). Significant effects of MPA status have occurred in recent years (2017-2018, Fig 3A), whereas Santa Rosa Island had significantly higher diversity than other islands until 2013, then significant lower diversity after 2016 (Fig 3B).
...
```{r Heat Map Summary and Cross Reference Tables, results = 'asis'}
heat_table <- heat_map %>%
  tidyr::drop_na() %>%
...
+ General interactions
  ...
  + Garibaldi biomass much higher outside of reserves where competition is reduced
  
  + Halfmoon and opaleye (herbivorous fish) have higher inside/outside biomass ratio where algaes tend to be more plentiful
